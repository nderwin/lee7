...
/**
 * 
 * @see https://github.com/arjantijms/mechanism-to-store-x/blob/master/jsr375/src/main/java/javax/security/authenticationmechanism/JaspicUtils.java
 */
public class JaspicUtils {
